...
module Global8ballGame
  RSpec.describe Game, type: :model do
    ...
    it "validates presence of player_1_id" do
      expect {Game.create config: @config, player_1_name: @player_1.name, player_2_id: @player_2.id, player_2_name: @player_2.name}.to raise_error "Global8ballGame::Game is not valid. Errors: player_1_id is not present."
    end
    ...
    it "validates presence of player_2_id" do
      expect {Game.create config: @config, player_1_id: @player_1.id, player_1_name: @player_1.name, player_2_name: @player_2.name}.to raise_error "Global8ballGame::Game is not valid. Errors: player_2_id is not present."
    end
    ...
    it "validates presence of player_2_name" do
      expect {Game.create config: @config, player_1_id: @player_1.id, player_1_name: @player_1.name, player_2_id: @player_2.id}.to raise_error "Global8ballGame::Game is not valid. Errors: player_2_name is not present."
    end
  end
end
